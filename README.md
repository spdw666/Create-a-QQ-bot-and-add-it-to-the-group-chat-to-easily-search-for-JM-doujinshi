...
| `@bot 下一页` | 查看上一次搜索的下一页（翻到底为止） | Next page of the last search (paginate until all results are seen) |
...
- **搜索结果翻页 Paginated results** — 每页 5 本，`@bot 下一页` 翻完所有匹配本子 / 5 per page, `@bot 下一页` pages through all matched albums
